...
<style>
	/*
	 * The full-size SVGs are transparent over most of the page. Let clicks pass
	 * through that empty area while keeping the painted Sankey paths interactive.
	 */
	.sankey-top,
	.sankey-back {
		pointer-events: none;
	...
	:global(.sankey-top path.sankey-path) {
