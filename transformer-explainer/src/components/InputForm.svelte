<script lang="ts">
	...
	const onFocusInput = (e) => {
		let formattedString = inputTextTemp.replace(/[\s\n]+/g, ' ');
			...
			>
				...
				{#if $isMobile}
					<span class="helper-text"
						>Try the examples. Please use a desktop computer to enter Qwen prompts directly.</span
					>
				{:else if $isLoaded && $isFetchingModel}
					<span class="helper-text">Preparing the Qwen model…</span>
				{:else if exceedLimit}
